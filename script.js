...
let back2home = document.getElementById("back");
...
back2home.addEventListener("click", () => {
    splashScreen.style.removeProperty("top");
    splashScreen.style.transition = ".75s";
});

let pilihText = document.querySelector(".textPilih");

batu.addEventListener("click", () => {
    janken(0);
    pilihText.textContent = "Anda memilih batu";
});

gunting.addEventListener("click", () => {
    janken(1);
    pilihText.textContent = "Anda memilih gunting";
});

kertas.addEventListener("click", () => {
    janken(2);
    pilihText.textContent = "Anda memilih kertas";
});
...
function result(who) {
    ...
    switch (who) {
        case "ken":
            ...
            winner.textContent = "Ninja Ken menang";
            break;
        case "player":
            skorPlayer++;
    ...
    timeOut = setTimeout(() => {
        ...
        winner.textContent = "";
        pilihText.textContent = "Tentukan Pilihanmu!";
    }, 3000);
}